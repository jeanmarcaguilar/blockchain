      ...
      <div class="col-lg-5" data-aos="fade-right">
        <div class="card-custom p-4 mb-4">
          ...
          <div class="d-flex gap-3 mb-4">
            <div class="stat-icon bg-primary bg-opacity-10 text-primary flex-shrink-0"><i class="fas fa-map-marker-alt"></i></div>
            <div><strong>Address</strong><p class="text-muted-custom small mb-0">123 Ayala Avenue, Makati City<br>Metro Manila 1226, Philippines</p></div>
          </div>
          <div class="d-flex gap-3 mb-4">
            <div class="stat-icon bg-success bg-opacity-10 text-success flex-shrink-0"><i class="fas fa-phone"></i></div>
            <div><strong>Phone</strong><p class="text-muted-custom small mb-0">+63 2 8123 4567<br>Mon–Fri, 9AM–6PM PHT</p></div>
          </div>
          <div class="d-flex gap-3 mb-4">
            <div class="stat-icon bg-info bg-opacity-10 text-info flex-shrink-0"><i class="fas fa-envelope"></i></div>
            <div><strong>Email</strong><p class="text-muted-custom small mb-0">support@blockcart.com<br>sales@blockcart.com</p></div>
          </div>
          <div class="d-flex gap-3">
            <div class="stat-icon bg-warning bg-opacity-10 text-warning flex-shrink-0"><i class="fas fa-clock"></i></div>
            <div><strong>Business Hours</strong><p class="text-muted-custom small mb-0">Monday – Friday: 9:00 AM – 6:00 PM<br>Saturday: 10:00 AM – 4:00 PM</p></div>
          </div>
        </div>
        ...
        <div class="card-custom overflow-hidden" style="height:320px;">
          <iframe
