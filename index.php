    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 text-center mt-5 mt-lg-0" data-aos="fade-left">
        <div class="position-relative">
          <div class="hero-glow" style="position:absolute;inset:-20px;background:radial-gradient(circle,rgba(44,59,77,.25) 0%,transparent 70%);filter:blur(40px);z-index:-1"></div>
...
<section class="py-5" id="recentlyViewedSection" style="display:none;">
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-up">
      <div><h2 class="section-title mb-0">Recently Viewed</h2><p class="text-muted-custom mb-0">Items you've looked at</p></div>
...
<section class="py-5" style="background:var(--primary-dark, #1B2632)">
  <div class="container text-center text-white" data-aos="fade-up">
    ...
    <form class="row g-2 justify-content-center max-w-600 mx-auto" style="max-width:500px" data-simulate="Subscribed successfully!">
      <div class="col-8"><input type="email" class="form-control form-control-custom" placeholder="Enter your email" required style="background:rgba(255,255,255,.15);border-color:rgba(255,255,255,.3);color:#fff"></div>
      <div class="col-4"><button type="submit" class="btn btn-light w-100" style="color:var(--primary);font-weight:600">Subscribe</button></div>
    </form>
  </div>
</section>
