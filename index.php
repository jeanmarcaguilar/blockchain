  ...
  <div class="container hero-content">
    <div class="row align-items-center">
      <div class="col-lg-6" data-aos="fade-right">
        ...
        <h1 class="display-4 fw-bold mb-3">Shop Securely with <span style="color:#10B981">BlockCart</span></h1>
        <p class="lead mb-4 opacity-90">Experience next-generation e-commerce where every transaction is immutably recorded on the Ethereum blockchain. Shop with confidence.</p>
        ...
        <div class="d-flex gap-4 mt-4 pt-3">
          <div><div class="fw-bold fs-4">10K+</div><small class="opacity-75">Happy Customers</small></div>
          <div><div class="fw-bold fs-4">500+</div><small class="opacity-75">Products</small></div>
          <div><div class="fw-bold fs-4">12K+</div><small class="opacity-75">Blockchain TXs</small></div>
        </div>
      </div>
      <div class="col-lg-6 text-center mt-5 mt-lg-0" data-aos="fade-left">
        <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600" alt="Shopping" class="img-fluid rounded-4 shadow-lg" style="max-height:420px;object-fit:cover">
      </div>
    </div>
  </div>
</section>
...
<section class="py-5 bg-white">
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-up">
      <div><h2 class="section-title mb-0">Featured Products</h2><p class="text-muted-custom mb-0">Handpicked for you</p></div>
...
<section class="py-5">
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-up">
      <div><h2 class="section-title mb-0">Best Sellers</h2><p class="text-muted-custom mb-0">Most popular this month</p></div>
...
<section class="py-5">
  <div class="container" data-aos="zoom-in">
    <div class="card-glass p-5 text-center" style="background:linear-gradient(135deg,rgba(37,99,235,.1),rgba(16,185,129,.1))">
      <h2 class="mb-3">Summer Sale — Up to 25% Off!</h2>
      <p class="text-muted-custom mb-4">Limited time offer on selected electronics and fashion items. All purchases blockchain-verified.</p>
      <a href="shop.php" class="btn btn-primary-custom btn-lg">Shop the Sale</a>
    </div>
  </div>
</section>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="<?= $i*100 ?>">
        <div class="card-custom p-4 text-center h-100">
          <div class="stat-icon bg-primary bg-opacity-10 text-primary mx-auto mb-3"><i class="fas <?= $f['icon'] ?>"></i></div>
          <h5><?= $f['title'] ?></h5>
...
<!-- Newsletter -->
<section class="py-5" style="background:linear-gradient(135deg,#1E3A8A,var(--primary))">
  <div class="container text-center text-white" data-aos="fade-up">
    ...
    <form class="row g-2 justify-content-center max-w-600 mx-auto" style="max-width:500px" data-simulate="Subscribed successfully!">
      <div class="col-8"><input type="email" class="form-control form-control-custom" placeholder="Enter your email" required></div>
      <div class="col-4"><button type="submit" class="btn btn-accent w-100">Subscribe</button></div>
    </form>
  </div>
</section>
...
document.addEventListener('DOMContentLoaded', () => {
  document.getElementById('homeCategories').innerHTML = BlockCartData.categories.map(c => `
    <div class="col-6 col-md-4 col-lg-2" data-aos="fade-up">
      <a href="shop.php?category=${c.slug}" class="card-custom d-block text-center p-3 text-decoration-none h-100">
        <div class="stat-icon bg-primary bg-opacity-10 text-primary mx-auto mb-2"><i class="fas ${c.icon}"></i></div>
