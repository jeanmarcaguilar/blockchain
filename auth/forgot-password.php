...
<div class="uw-shell">
  ...
  <div class="uw-right">
    <div class="uw-right-inner" data-aos="fade-up">
      <div class="uw-status-badge"><i class="fas fa-key"></i></div>
      <h1>Forgot Password?</h1>
      <p class="uw-sub-text">Enter your email and we'll send you a reset link</p>
      ...
      <form data-simulate="Password reset link sent! Check your email.">
        ...
        <button type="submit" class="uw-submit"><i class="fas fa-paper-plane me-2"></i>Send Reset Link</button>
      </form>
